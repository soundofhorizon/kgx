        ...
        try:
            ...
            def createRankingEmbed():
                ...
                for member in range(self.bot.get_guild(558125111081697300).member_count):
                    ...
                    memberList.append(self.bot.get_guild(558125111081697300).members[member].display_name)
            ...
            def createHighBidRanking():
                ...
                for i in range(len(radis_get_data_list)):
                    ...
                    description += f"{i + 1}位: 出品者->{self.bot.get_user(int(radis_get_data_list[i][3])).display_name}\n" \
            ...
            if message.content.startswith("!set_user_auction_count"):
                ...
                await message.channel.send(f"{self.bot.get_user(int(msg[0])).display_name}さんのオークションの開催個数を**{auction_now}**個にセットしました。")
            ...
            if message.channel.id == 558265536430211083 and message.content.startswith('!bidscore'):
                ...
                if p.fullmatch(msg):
                    ...
                    await channel.send(embed=createRankingEmbed())
            ...
            if message.content == "!check_role":
                ...
                for member in range(self.bot.get_guild(558125111081697300).member_count):
                    ...
                    await message.channel.send(self.bot.get_guild(558125111081697300).members[member])
                    before, after, embed = checkRole(score, self.bot.get_guild(558125111081697300).members[member])
            ...
            if message.content.startswith('!bidscoreGS'):
                if discord.utils.get(message.author.roles, name="Administrator"):
                    ...
                    if message.content.split(" ")[1] == "get":
                        ...
                        embed = discord.Embed(
                            description=f"{message.author.display_name}により、ユーザー名：{self.bot.get_user(int(message.content.split(' ')[2])).display_name}"
                        ...
                        channel = self.bot.get_channel(CHANNEL_ID)
                        embed = discord.Embed(
                            description=f"{message.author.display_name}により、{self.bot.get_user(int(message.content.split(' ')[2])).display_name}"
